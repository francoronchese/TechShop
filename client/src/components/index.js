...
export { ProductDescriptionBlock } from "./product/single-product/ProductDescriptionBlock.jsx";
export { ProductGalleryBlock } from "./product/single-product/ProductGalleryBlock.jsx";

// Cart components
export { ShoppingCartIcon } from "./cart/ShoppingCartIcon.jsx";
export { ShoppingCart } from "./cart/ShoppingCart.jsx";
